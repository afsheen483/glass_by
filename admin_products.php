...
if(isset($_GET['delete'])){
    ...
    if(md5($del)==$enc){
        ...
        $prescription = "delete from glassBuy_prescription where id='$del'";
        $con->query($prescription);
    }
...
include('./includes/sidebar.php');} ?>
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <h5>Products</h5>
                <a href="?id=new" class="button">Add Glasses</a>  <a href="?id=new" class="button">Add Accessories</a>
                <?php  if(true){?>
                ...
                <table >
                    <thead>
                        ...
                        <tbody>
                            ...
                            $query  ="SELECT * FROM `glassbuy_glasses`";
                            //echo $query;
                            $od = getAll($con, $query);
                            //dd($od);
                            foreach($od as $row){
                ...
                <div style="" id="component_1584107435" class="composite_component component paged options-style-thumbnails paginate-results multistep autotransition active" data-nav_title="Prescription" data-item_id="1584107435">
                                                            ...
                                                            <div class="">
                                                                <h2 class="step_title_wrapper component_title">
                                                                    <span class="aria_title" aria-label="Prescription" tabindex="-1">Glasses</span>
                                                            ...
                                                            <div style="display: block;" id="" class="">
                                                                <div class="component_description_wrapper">
                                                                    <div class="component_description"><p>Insert Glasses</p></div>
                                                                </div>
                                                                <div class="">
