...
if (isset($_POST['submit'])) {
    ...
    $id = $_GET['update_id'];
        ...
        $query = "UPDATE `glassbuy_glasses` SET `title` = '$title',`price` = '$price', `manufacturer` = '$manufacturer', `cost` = '$cost' WHERE `id` = '$id'";
        $fire = mysqli_query($con,$query) or die(mysqli_error($con));
        if ($fire) {
            setFlash("error","Accessories updated Successfully.","alert-success");
...
if (isset($_GET['update_id'])) {
    $id = $_GET['update_id'];
    $edit_query = "SELECT * FROM `glassbuy_glasses` WHERE `productCategory` = 'Accessories' AND `id` = '$id'";
    $fire_edit = mysqli_query($con,$edit_query);
    $fetch_row = mysqli_fetch_assoc($fire_edit);
   // dd($fetch_row);
}
?>
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th>Title</th>
                            <td><input type="text" name="title" class="col-4" placeholder="Enter frame name" value="<?php echo $fetch_row['title'] ?>">
                    ...
                    <tbody>
                        <tr><td>Price</td>
                        <td><input type="text" placeholder="$" class="col-4" name="price" value="<?php echo $fetch_row['price'] ?>"></td>
                        </tr>
                        <tr><td>Cost</td>
                    <td><input type="text" placeholder="$" class="col-4" name="cost" value="<?php echo $fetch_row['cost'] ?>"></td></tr>
                        <tr><td>Manufacturer</td>
                    <td><input type="text" placeholder="Enter manufacturer" class="col-4" name="manufacturer" value="<?php echo $fetch_row['manufacturer'] ?>"></td></tr>
