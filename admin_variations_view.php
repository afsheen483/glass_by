    ...
    <?php include('./includes/sidebar.php'); ?>
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <a href="./admin_glasses.php" class="btn-link">Glasses</a>
                    ...
                    <br><br>
                    <!-- <a href="./glasses_variation.php" class="btn-link" style="float:right">Glasses Variation</a> -->
                ...
                <a  class="button" href="./glasses_variation.php">Add Variation</a>
                <?php  }?>
                ...
                <table class="table display responsive nowrap" width="100%">
                   ...
                   <tbody>
                       <?php  $query = "SELECT * FROM `glassbuy_glass_variations`";
                                $fire = mysqli_query($con,$query);
                                while ($row = mysqli_fetch_assoc($fire)){
                                    ?>
                                    <tr>
                                        <td></td>
                                        <td><?php echo $row['color_code_1']; ?></td>
                                        <td><?php echo $row['color_1']; ?></td>
                                        <td><?php echo $row['color_2']; ?></td>
                                        <td><?php echo $row['size']; ?></td>
                                        <td><?php echo $row['frame_a_width']; ?></td>
                                        <td><?php echo $row['frame_b_height']; ?></td>
                                        <td><?php echo $row['frame_ed']; ?></td>
                                        <td><?php echo $row['frame_db_bridge']; ?></td>
                                        <td><?php echo $row['frame_temple_legs']; ?></td>
                                        <td><?php echo $row['frame_total_width']; ?></td>
                                        <td><?php echo $row['minimum_pd_p_sph']; ?></td>
                                        <td><?php echo $row['minimum_pd_n_sph']; ?></td>
                                        <td><?php echo $row['file']; ?></td>
                                        <td>
                                        <a href="edit_glasses.php?update_id=<?php echo $rows['id']?>" class="btn-sm btn-warning"  id="update">Edit Data</a>
