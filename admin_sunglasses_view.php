    ...
    <?php include('./includes/sidebar.php'); ?>
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <div class="rightSideBox">
                    <a href="./admin_glass_form.php" class="btn-link">Glasses</a>
                ...
                <table class="table display responsive nowrap" width="100%">
                   ...
                   <tbody>
                       <?php  $query = "SELECT * FROM `glassbuy_glasses` WHERE `productCategory` = 'SunGlasses'";
                                ...
                                while ($row = mysqli_fetch_assoc($fire)){
                                    ...
                                    <tr>
                                        ...
                                        <a href="./glasses_variation.php?id=<?php echo $row['id']?>" class="btn-sm btn-warning">Glasses Variation</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
