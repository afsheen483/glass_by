...
function populate_prescription(prescription_arr) {
    ...
    jQuery('ul.products li:first-child .wc-pao-addon-sph select option[data-label="' + prescription_arr.sphere_right + '"]').attr('selected', 'selected');
    jQuery('ul.products li:first-child .wc-pao-addon-cyl select option[data-label="' + prescription_arr.cylinder_right + '"]').attr('selected', 'selected');
    jQuery('ul.products li:first-child .wc-pao-addon-axis input').val(prescription_arr.axis_right);
    jQuery('ul.products li:first-child .wc-pao-addon-add select option[data-label="' + prescription_arr.add_right + '"]').attr('selected', 'selected');
    jQuery('ul.products li:first-child .wc-pao-addon-pd select option[data-label="' + prescription_arr.pd_right + '"]').attr('selected', 'selected');
	jQuery('ul.products li:first-child .wc-pao-addon-pd select').change();
    jQuery('ul.products li:nth-child(2) .wc-pao-addon-sph select option[data-label="' + prescription_arr.sphere_left + '"]').attr('selected', 'selected');
    jQuery('ul.products li:nth-child(2) .wc-pao-addon-cyl select option[data-label="' + prescription_arr.cylinder_left + '"]').attr('selected', 'selected');
    jQuery('ul.products li:nth-child(2) .wc-pao-addon-axis input').val(prescription_arr.axis_left);
    jQuery('ul.products li:nth-child(2) .wc-pao-addon-add select option[data-label="' + prescription_arr.add_left + '"]').attr('selected', 'selected');
    jQuery('ul.products li:nth-child(2) .wc-pao-addon-pd select option[data-label="' + prescription_arr.pd_left + '"]').attr('selected', 'selected');
	jQuery('ul.products li:nth-child(2) .wc-pao-addon-pd select').change();
...
function savePrescriptionAndAddFrameToCart(user_id, ajaxurl, product_id, quantity, var_id, item) {
	...
	jQuery('#review-sidebar .widget_composite_summary .composite_button button.single_add_to_cart_button').addClass("disabled-btn");
}
