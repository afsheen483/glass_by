...
function ajaxSubmit(){
	...
	return jQuery.ajax({
        ...
        success:function(e){
			...
			if(e.loggedin) {
				jQuery(".component_data #inline-1").html('<a href="#" class="switch-presc">Change Prescription Method</a><div class="sp-prescription-loader"><img src="/wp-content/themes/bb-theme-child/assets/images/loader.gif"></div><div class="saved-presc"><div class="wrapper-popup">' + e.prescription + '</div></div>');
			}
