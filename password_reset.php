...
if(isset($_GET['token'])){
    $token = $_GET['token'];
    $query = "SELECT * FROM glassBuy_users WHERE passwordResetId='$token'";
...
if(isset($_POST['password'])){
    ...
    $sql="update glassBuy_users set password='$password' where passwordResetId='$token'";
                                                                    		...
                                                                    		<p>Email Sent. Kindly check your spam box as well.</p>
                                                                                            ...
                                                                                            <form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
                                                                                                ...
                                                                                                <p class="form-row form-button">
                                                                                                   <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Send Email">Reset Password</button>
