<?php 
  ...
  '$r_sph','$r_cyl','$r_axis','$r_add','$l_sph','$l_cyl','$l_axis','$l_add','$lens_type','$quantity',
...
$success_url  = $g_project_url.'view_order.php?pId='.($last_id)."thankyou=thankyou";
  ...
  header("Location:?m=Amount must me greater than 0");
    ...
    $od = $_GET['od'];
  $pastOrder = getRow($con, "SELECT * from glassBuy_order_details od inner join glassBuy_order o on o.id=od.order_id where o.user_id='$session_userId' and o.id='$od'");
  // var_dump($pastOrder);
  ?>
  <!DOCTYPE html>
  <html lang="en-US">
...
<?if(!isset($_GET['od'])){?>
<?php
  $rows = getAll($con, "SELECT * from glassBuy_order_details od inner join glassBuy_order o on o.id=od.order_id where o.user_id='$session_userId' ");
?>
 <div id="order_review" class="woocommerce-checkout-review-order">
  <div class="checkout-items">
  <h3 id="order_review_heading">Old Order Data</h3>

  <table id="myTable" class="shop_table woocommerce-checkout-review-order-table">
...
<tbody>
 ...
 foreach($rows as $row){
  ...
  <tr>
      ...
      <td><a class="btn btn-warning use-address" href="?od=<?echo $row['order_id']?>">Used To Fill data </a></td>
...
?>
  ...
  <input type="text" class="input-text" name="billing_first_name" id="billing_first_name" placeholder="" value="<?echo $pastOrder['fname']?>" autocomplete="given-name" />
  </span>
  </p>
  <p class="form-row form-row-last validate-required" id="billing_last_name_field" data-priority="20">
  <label for="billing_last_name" class="">Last name&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="billing_last_name" id="billing_last_name" placeholder="" value="<?echo $pastOrder['lname']?>" autocomplete="family-name" />
  </span>
  </p>
  ...
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="billing_city" id="billing_city" placeholder="" value="<?echo $pastOrder['city']?>" autocomplete="address-level2" />
  </span>
  </p>
  <p
  ...
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="billing_state" id="billing_city" placeholder="" value="<?echo $pastOrder['province']?>" autocomplete="address-level2" />
  ...
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="billing_postcode" id="billing_postcode" placeholder="" value="<?echo $pastOrder['postal_code']?>" autocomplete="postal-code" />
  </span>
  </p>
  ...
  <?foreach($g_countries as $country){?>
  <option <?if($country=="United States"){echo "selected";}?>><?echo $country?></option>
  <?}?>
  </select>
  ...
  <span class="woocommerce-input-wrapper">
  <input type="tel" class="input-text" name="billing_phone" id="billing_phone" placeholder="" value="<?echo $pastOrder['phone']?>" autocomplete="tel" />
  </span>
  </p>
  <p class="form-row form-row-wide validate-required validate-email" id="billing_email_field" data-priority="110">
  <label for="billing_email" class="">Email address&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="email" class="input-text" name="billing_email" id="billing_email" placeholder="" value="<?echo $session_email?>" autocomplete="email username" />
  </span>
  </p>
  ...
  <label for="billing_first_name" class="">First name&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="c_billing_first_name" id="billing_first_name" placeholder="" value="<?echo $pastOrder['fname']?>" autocomplete="given-name" />
  </span>
  </p>
  <p class="form-row form-row-last validate-required" id="billing_last_name_field" data-priority="20">
  <label for="billing_last_name" class="">Last name&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="c_billing_last_name" id="billing_last_name" placeholder="" value="<?echo $pastOrder['lname']?>" autocomplete="family-name" />
  </span>
  </p>
  <p class="form-row address-field validate-required form-row-wide" id="billing_address_1_field" data-priority="25">
  <label for="billing_address_1" class="">Address Line 1&nbsp;<abbr class="required" title="required">*</abbr></label>
  ...
  <label for="billing_city" class="">City&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="c_billing_city" id="billing_city" placeholder="" value="<?echo $pastOrder['city']?>" autocomplete="address-level2" />
  </span>
  </p>
  <p
  class="form-row address-field validate-required validate-state form-row-wide"
  ...
  <label for="billing_state" class="">State&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="c_billing_state" id="billing_city" placeholder="" value="<?echo $pastOrder['state']?>" autocomplete="address-level2" />
  ...
  <label for="billing_postcode" class="">Postal code&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="text" class="input-text" name="c_billing_postcode" id="billing_postcode" placeholder="" value="<?echo $pastOrder['postal_code']?>" autocomplete="postal-code" />
  </span>
  </p>
  <p class="form-row form-row-wide address-field update_totals_on_change validate-required" id="billing_country_field" data-priority="95">
  <label for="billing_country" class="">Country / Region&nbsp;<abbr class="required" title="required">*</abbr></label>
  ...
  <label for="billing_phone" class="">Phone&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="tel" class="input-text" name="c_billing_phone" id="billing_phone" placeholder="" value="<?echo $pastOrder['phone']?>" autocomplete="tel" />
  </span>
  </p>
  <p class="form-row form-row-wide validate-required validate-email" id="billing_email_field" data-priority="110">
  <label for="billing_email" class="">Email address&nbsp;<abbr class="required" title="required">*</abbr></label>
  <span class="woocommerce-input-wrapper">
  <input type="email" class="input-text" name="c_billing_email1" id="billing_email" placeholder="" value="<?echo $session_email?>" autocomplete="email username" />
  </span>
  </p>
  <div class="woocommerce-additional-fields">
  <div class="woocommerce-additional-fields__field-wrapper">
  ...
  $rowd = $product_data->fetch_assoc();
  $p_name = $rowd['title'];
  $p_price = $rowd['price']*$pidinfo['quantity'];
  $desc = $rowd['additional_info'];
  }?>
  <tr class="cart_item">
  <td class="product-name"><?echo $p_name?><strong class="product-quantity">×&nbsp;1</strong></td>
  <td class="product-total">
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $p_price?></bdi>
  </span>
  </td>
  </tr>
  <?}?>
  ...
  <td class="product-total">
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $Prescription_Lenses_cost_total?>.00</bdi>
  </span>
  </td>
  </tr>
  <?}?>
  ...
  <th><?echo $ass[0]?> x <?echo $ass[2]?></th>
  <td>
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><? $a =  $ass[1] * $ass[2];
  $subbtotal+= $a;
  echo $a;?></bdi>
  </span>
  </td>
  ...
  <td>
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $subbtotal?></bdi>
  </span>
  </td>
  </tr>
  ...
  <td data-title="Shipping">$<span class="woocommerce-Price-amount amount"><?echo $discount?></span></td>
  </tr>
  ...
  <td>
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $tax;?></bdi>
  </span>
  </td>
  </tr>
  ...
  <td>
  <strong>
  <input name="total" value="<?echo round(($tax+ $subbtotal + 9+$assTotal) - $discount, 2)?>" hidden>
  <span class="woocommerce-Price-amount amount">
  <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo round(($tax+ $subbtotal + 9+$assTotal) - $discount, 2)?></bdi>
  </span>
  </strong>
  </td>
  </tr>
