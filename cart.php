                                                                                    ...
                                                                                    <table class="shop_table shop_table_responsive" cellspacing="0">
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr class="woocommerce-shipping-totals shipping">
                                                                                                ...
                                                                                                <td data-title="<?echo $ass[0]?>"><span class="woocommerce-Price-amount amount">$ <?echo $ass[1] * $ass[2]?></span></td>
                                                                                            </tr>
                                                                                            <?}?>
                                                                                            <tr class="tax-total">
                                                                                                <th>Tax</th>
                                                                                                <td data-title="Tax">
                                                                                                    <span class="woocommerce-Price-amount amount">
                                                                                                        <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $tax = round(($subbtotal * 0.04712), 2)?></bdi>
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr class="tax-total">
