...
if(isset($_GET['print']) && !isset($_GET['norecurs'])){
    ...
    if(!isset($_GET['norecurs'])){
        	    ...
        	    ?>
                <script>window.open('<?echo $content?>', '_blank'); </script>
                <?
...
margin: 0;">
    ...
    font-size: 30px;">
                    <span class="title-text pp-primary-title">ORDER ID # <?echo $orderId?></span>
                </h2>
                
                <?if(!isset($_GET['print'])){?>
                
                 <a target="_blank" class="button" href="?id=<?echo $_GET['id']?>&print=<?echo $_GET['id']?>" style="color:white;">Print</a>
                ...
                <div class="row">
                    <div class='col-sm-4'>
                        ...
                        <p><b>Firstname: </b><?echo $orderDetailsDeets['fname']?></p>
                        <p><b>Lastname: </b><?echo $orderDetailsDeets['lname']?></p>
                        <p><b>DOB: </b></p>
                        <p><b>Shipping Address: </b><?echo $orderDetailsDeets['city']?> <?echo $orderDetailsDeets['province']?> <?echo $orderDetailsDeets['postalcode']?> <?echo $orderDetailsDeets['country']?></p>
                        <p><b>Email ID: </b><?echo $orderDetailsDeets['email']?></p>
                        <p><b>Phone Number: </b><?echo $orderDetailsDeets['phone']?></p>
                        
                        <h3>Order Details</h3>
                        <p><b>Frame Title: </b><?echo $orderDetailsDeets['product_name']?></p>
                        <p><b>Frame Color: </b><?echo $productDeets['colour']?></p>
                        <small>
                        <p><span>Lens Type: </span><?echo $orderDetailsDeets['lensType']?></p>
                        <p><span>Lens Enhancement: </span><?echo $orderDetailsDeets['vision']?></p>
                        ...
                        <hr>
                        <?foreach($myaccessories as $row){?>
                        <p><span><?echo $row[0]?> </span><?echo $row[1]?></p>
                        <?}?>
                        </small>
                    ...
                    <div class='col-sm-4'>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <th>Right Eye</th>
                                <td><?echo $prescriptionDeets['r_sph']?></td>
                                <td><?echo $prescriptionDeets['r_cyl']?></td>
                                <td><?echo $prescriptionDeets['r_axis']?></td>
                                <td><?echo $prescriptionDeets['r_add']?></td>
                            </tr>
                            <tr>
                                <th>Left Eye</th>
                                <td><?echo $prescriptionDeets['l_sph']?></td>
                                <td><?echo $prescriptionDeets['l_cyl']?></td>
                                <td><?echo $prescriptionDeets['l_axis']?></td>
                                <td><?echo $prescriptionDeets['l_add']?></td>
                            </tr>
                        </table>


                        <p><b>PD: </b><?echo $prescriptionDeets['pd']?></p>
                        <p><b>PD Photo: </b>
                        <?if($prescriptionDeets['file_name']!=""){?>
                            <img src="./uploads/<?echo $prescriptionDeets['file_name']?>" style="width:100%;">
                            <br>
                            <a download href="./uploads/<?echo $prescriptionDeets['file_name']?>">Download</a>
                            <?}?>
                        </p>
                        <p><b>PD Measurement Photo: </b>
                        <?if($prescriptionDeets['pdimage']!=""){?>
                            <img src="./uploads/<?echo $prescriptionDeets['pdimage']?>" style="width:100%;">
                            <br>
                            <a download href="./uploads/<?echo $prescriptionDeets['pdimage']?>">Download</a>
                            <?}?>
                        </p>
                        ...
                        <div id="order_review" class="woocommerce-checkout-review-order">
                                                                                <div class="checkout-items">
                                                                                    ...
                                                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                                                        <tbody>
                                                                                            <tr class="cart_item">
                                                                                                <td class="product-name"><?echo $orderDetailsDeets['product_name']?><strong class="product-quantity">×&nbsp;1</strong></td>
                                                                                                <td class="product-total">
                                                                                                    <span class="woocommerce-Price-amount amount">
                                                                                                        <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $productDeets['price']?></bdi>
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <style>
                                                                                            ...
                                                                                            <tr class="cart_item">
                                                                                                ...
                                                                                                <td class="product-total">
                                                                                                    <span class="woocommerce-Price-amount amount">
                                                                                                        <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo $Prescription_Lenses_cost?>0.00</bdi>
                                                                                                    </span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <tfoot>
                                                                                            ...
                                                                                            <?$discount = round(($_SESSION['coupon_discount']/100) * $productDeets['price'], 2);
                                                                                            ...
                                                                                            <tr class="order-total">
                                                                                                ...
                                                                                                <td>
                                                                                                    <strong>
                                                                                                        <input name="total" value="<?echo round(($tax+ $productDeets['price'] + 9) - $discount, 2)?>" hidden>
                                                                                                        <span class="woocommerce-Price-amount amount">
                                                                                                            <bdi><span class="woocommerce-Price-currencySymbol">$</span><?echo round(($tax+ $productDeets['price'] + 9) - $discount, 2)?></bdi>
                                                                                                        </span>
                                                                                                    </strong>
                                                                                                </td>
                                                                                            </tr>
