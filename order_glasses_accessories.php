                ...
                <div class="row">
                    ...
                    <div class='col-sm-4'>
                        ...
                        <table class="table" border="1">
                            <tr>
                                <th>Lens Type</th>
                                <td><?php echo $orderDetailsDeets['lensType']?></td>
                            </tr>
                            <tr>
                                <th>Lens Enhancement</th>
                                <td><?php echo $orderDetailsDeets['vision']?></td>
                            </tr>
                            <tr>
                                <th>UV Protection</th>
                                <td></td>
                        ...
                        <table class="table" border = "1">
                            ...
                            <tr>
                                <th>Right Eye</th>
                                <td><?php echo $prescriptionDeets['r_sph']?></td>
                                <td><?php echo $prescriptionDeets['r_cyl']?></td>
                                <td><?php echo $prescriptionDeets['r_axis']?></td>
                                <td><?php echo $prescriptionDeets['r_add']?></td>
                                <td rowspan="2"><?php echo $prescriptionDeets['pd']?></td>
                                <td> 
                                <?php if($prescriptionDeets['file_name']!=""){?>
                                    <img src="./uploads/<?php echo $prescriptionDeets['file_name']?>" style="width:100%;">
                                        <br>
                                    <a download href="./uploads/<?php echo $prescriptionDeets['file_name']?>">Download</a>
                                    <?php }?>
                                 </td>
                            </tr>
                            <tr>
                                <th>Left Eye</th>
                                <td><?php echo $prescriptionDeets['l_sph']?></td>
                                <td><?php echo $prescriptionDeets['l_cyl']?></td>
                                <td><?php echo $prescriptionDeets['l_axis']?></td>
                                <td><?php echo $prescriptionDeets['l_add']?></td>
                                <td><?php if($prescriptionDeets['pdimage']!=""){?>
                            <img src="./uploads/<?php echo $prescriptionDeets['pdimage']?>" style="width:100%;">
                            <br>
                            <a download href="./uploads/<?php echo $prescriptionDeets['pdimage']?>">Download</a>
                            <?php }?></td>
                            </tr>
                        </table>
