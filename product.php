                                                                ...
                                                                <div class="single_variation_wrap">
                                                                    ...
                                                                    <div class="woocommerce-variation-add-to-cart variations_button">
                                                                        ...
                                                                        <?php
                                                                                ...
                                                                                $query = "SELECT * FROM `glassbuy_favourites` WHERE `product_id` = '$product_id' AND `user_id` = '$session_userId'";
                                                                                $fire = mysqli_query($con,$query);
                                                                                $row = mysqli_fetch_assoc($fire);
                                                                                if ($row['id'] != NULL || $row['id'] != '') {
                                                                                   ?>
                                                                                        <a style="margin: 1px auto; justify-content: center;display: flex;width:180%;"  id="<?php echo $glassDeets['glass_id'] ?>" href = "#" class="btn unfvrt" >Add to Favourites <i class="fa fa-heart heart" style="margin-left:2%;color:red;font-size:20px"></i></a>
                                                                                   <?php
                                                                                }else{
                                                                                    ?>
                                                                                    <a style="margin: 1px auto; justify-content: center;display: flex;width:180%"  id="<?php echo $glassDeets['glass_id'] ?>" href = "#" class="btn fvrt">Add to Favourites <i class="fa fa-heart heart" style="margin-left:2%;font-size:20px"></i></a>
                                                                                    <?php
