    ...
    <?php include('./includes/sidebar.php'); ?>
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <div class="alert alert-danger" role="alert">
                    Please note "Edit/Delete" the address won't affect your existing order. Please contact service@firmoo.com if you want to change 
                    the shipping addressin your order.
                </div>
