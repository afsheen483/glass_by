    ...
    <?php include('./includes/sidebar.php'); ?>
           ...
           <?php 
            ...
            <div class="woocommerce-MyAccount-content">
                ...
                <?php  }?>
                <a href="./add_accessories.php" class="button">Add Accessories</a>
                ...
                <table class="table display responsive nowrap" width="100%">
                   ...
                   <tbody>
                       <?php  $query = "SELECT * FROM `glassbuy_glasses` WHERE `productCategory` = 'Accessories'";
                                ...
                                while ($row = mysqli_fetch_assoc($fire)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="admin_accessories_edit.php?update_id=<?php echo $row['id']?>" class="btn-sm btn-warning"  id="update">Edit Data</a>
